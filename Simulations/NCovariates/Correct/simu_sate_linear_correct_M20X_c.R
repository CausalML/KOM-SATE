...
KOM <- function(dta,Type_kernel,hpara,GPML){
  ...
  X <- as.matrix(data.frame(dta$Z1, dta$Z1, dta$Z2, dta$Z3, dta$Z4, dta$Z5, dta$Z6, dta$Z7, dta$Z8, dta$Z9, dta$Z10,
                            dta$Z11, dta$Z12, dta$Z13, dta$Z14, dta$Z15, dta$Z16, dta$Z17, dta$Z18, dta$Z19, dta$Z20))
...
for(beta in seqqbeta){  
  ...
  save.image("simu_linear_correct_191018_n200_20X.RData")
}
