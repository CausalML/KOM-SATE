...
sbw_result <- function(dta,degree,BAL_TOLS){
  ...
  if(degree==1){
    data_frame = as.data.frame(cbind(dta$Y, dta$Tr, dta$Z1, dta$Z2, dta$Z3, dta$Z4, dta$Z5, dta$Z6, dta$Z7, dta$Z8, dta$Z9, dta$Z10,
                                     ...
                                     dta$Z51, dta$Z52, dta$Z53, dta$Z54, dta$Z55, dta$Z56, dta$Z57, dta$Z58, dta$Z59, dta$Z60,
                                     dta$Z61, dta$Z62, dta$Z63, dta$Z64, dta$Z65, dta$Z66, dta$Z67, dta$Z68, dta$Z69, dta$Z70,
                                     dta$Z71, dta$Z72, dta$Z73, dta$Z74, dta$Z75, dta$Z76, dta$Z77, dta$Z78, dta$Z79, dta$Z80,
                                     dta$Z81, dta$Z82, dta$Z83, dta$Z84, dta$Z85, dta$Z86, dta$Z87, dta$Z88, dta$Z89, dta$Z90,
                                     dta$Z91, dta$Z92, dta$Z93, dta$Z94, dta$Z95, dta$Z96, dta$Z97, dta$Z98, dta$Z99, dta$Z100))
...
for(beta in seqqbeta){  
  ...
  save.image("simu_linear_correct_191018_n200_100X_sbw.RData")
}
